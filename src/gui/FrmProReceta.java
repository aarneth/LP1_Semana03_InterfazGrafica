...
public class FrmProReceta extends JInternalFrame implements ActionListener {
	...
	public FrmProReceta() {
		...
		lblCantidad.setBounds(386, 145, 115, 24);
		...
		btnCancelar.setForeground(new Color(255, 69, 0));
		...
		lblDniPaciente.setBounds(50, 76, 89, 24);
		...
		lblNReceta.setBounds(386, 77, 89, 24);
		...
		textField_7.setBounds(487, 337, 179, 20);
		getContentPane().add(textField_7);
		
		textField_8 = new JTextField();
		textField_8.setColumns(10);
		textField_8.setBounds(487, 372, 179, 20);
		...
		textField_9.setBounds(487, 405, 179, 20);
		getContentPane().add(textField_9);
		
		lblTipoSangre = new JLabel("Tipo Sangre:");
		lblTipoSangre.setBounds(386, 403, 98, 24);
